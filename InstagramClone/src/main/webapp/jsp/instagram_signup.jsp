...
<link rel="stylesheet" href="../css/instagram_signup.css" />
		...
		<section id="auth" class="flex direction-column">
			<div class="panel login flex direction-column">
				...
				<form class="form">
					...
					<div class="input-div">
						<input name="email" type="text" placeholder="휴대폰 번호 또는 이메일 주소" /> 
					...
					<div class="facebook-button-div">
						<button type="button" class="login-with-fb flex direction-row align-items-center justify-content-center">가입</button>
					</div>
				</form>
			</div>
			...
			<div class="app-download flex direction-column align-items-center">
				...
				<div class="flex justify-content-center">
					<img src="../images/apple-button.png"
